//
//  YimaiExaminationTableViewContentCell.h
//  DoctorPlatForm
//
...
@interface YimaiExaminationTableViewContentCell : UITableViewCell<DTAttributedTextContentViewDelegate, DTLazyImageViewDelegate>
