//
//  YimaiExaminationTableViewCommonContentCell.m
//  DoctorPlatForm
//
...
@interface YimaiExaminationTableViewCommonContentCell ()<ZLPhotoPickerBrowserViewControllerDataSource,ZLPhotoPickerBrowserViewControllerDelegate>
...
@implementation YimaiExaminationTableViewCommonContentCell

static NSString *const identifier = @"YimaiExaminationTableViewCommonContentCell";

+ (instancetype)cellWithTabelView:(UITableView *)tableView
{
    YimaiExaminationTableViewCommonContentCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
...
-(void)setQuestionModel:(YimaiExaminationQuestionModel *)questionModel
{
    ...
    [self setCoreTextString:questionModel.commonContent textView:self.answerLabelView];
}
