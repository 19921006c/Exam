//
//  YimaiExaminationTableViewContentCell.m
//  DoctorPlatForm
//
...
@interface YimaiExaminationTableViewContentCell ()<ZLPhotoPickerBrowserViewControllerDataSource,ZLPhotoPickerBrowserViewControllerDelegate>
...
@implementation YimaiExaminationTableViewContentCell

static NSString *const identifier = @"YimaiExaminationTableViewContentCell";

+ (instancetype)cellWithTabelView:(UITableView *)tableView
{
    YimaiExaminationTableViewContentCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
...
-(void)setQuestionModel:(YimaiExaminationQuestionModel *)questionModel
{
    ...
    [self setCoreTextString:questionModel.content textView:self.answerLabelView];
}
