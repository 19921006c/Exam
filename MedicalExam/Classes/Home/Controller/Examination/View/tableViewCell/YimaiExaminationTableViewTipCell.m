//
//  YimaiExaminationTableViewTipCell.m
//  DoctorPlatForm
//
...
@interface YimaiExaminationTableViewTipCell ()<ZLPhotoPickerBrowserViewControllerDataSource,ZLPhotoPickerBrowserViewControllerDelegate>
...
@implementation YimaiExaminationTableViewTipCell

static NSString *const identifier = @"YimaiExaminationTableViewTipCell";

+ (instancetype)cellWithTabelView:(UITableView *)tableView
{
    YimaiExaminationTableViewTipCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    
    if (cell == nil) {
        cell = [[[NSBundle mainBundle] loadNibNamed:identifier owner:self options:nil] lastObject];
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        
        cell.tipView.shouldDrawImages = NO;
        cell.tipView.shouldDrawLinks = NO;
        cell.tipView.textDelegate = cell;
    }
...
-(void)setQuestionModel:(YimaiExaminationQuestionModel *)questionModel
{
    ...
    [self setCoreTextString:questionModel.tips textView:self.tipView];
}
